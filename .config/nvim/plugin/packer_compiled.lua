...
_G.packer_plugins = {
  ...
  ["cmp-buffer"] = {
    after_files = { "/home/sam/.local/share/nvim/site/pack/packer/opt/cmp-buffer/after/plugin/cmp_buffer.lua" },
    load_after = {},
    loaded = true,
    needs_bufread = false,
    path = "/home/sam/.local/share/nvim/site/pack/packer/opt/cmp-buffer",
  ...
  ["everforest-nvim"] = {
    loaded = true,
    path = "/home/sam/.local/share/nvim/site/pack/packer/start/everforest-nvim",
    url = "https://github.com/neanias/everforest-nvim"
  },
  ["julia-vim"] = {
    loaded = true,
    path = "/home/sam/.local/share/nvim/site/pack/packer/start/julia-vim",
    url = "https://github.com/JuliaEditorSupport/julia-vim"
  },
  ["kanagawa.nvim"] = {
    loaded = true,
    path = "/home/sam/.local/share/nvim/site/pack/packer/start/kanagawa.nvim",
  ...
  ["python-syntax"] = {
    loaded = true,
    path = "/home/sam/.local/share/nvim/site/pack/packer/start/python-syntax",
    url = "https://github.com/vim-python/python-syntax"
  },
  ["quarto-vim"] = {
    loaded = true,
    path = "/home/sam/.local/share/nvim/site/pack/packer/start/quarto-vim",
    url = "https://github.com/quarto-dev/quarto-vim"
  },
  tabular = {
    loaded = true,
    path = "/home/sam/.local/share/nvim/site/pack/packer/start/tabular",
  ...
  ["transparent.nvim"] = {
    loaded = true,
    path = "/home/sam/.local/share/nvim/site/pack/packer/start/transparent.nvim",
  ...
  ["vim-fish"] = {
    loaded = true,
    path = "/home/sam/.local/share/nvim/site/pack/packer/start/vim-fish",
  ...
  ["vim-go"] = {
    loaded = true,
    path = "/home/sam/.local/share/nvim/site/pack/packer/start/vim-go",
  ...
  ["vim-pandoc-syntax"] = {
    loaded = true,
    path = "/home/sam/.local/share/nvim/site/pack/packer/start/vim-pandoc-syntax",
    url = "https://github.com/vim-pandoc/vim-pandoc-syntax"
  },
  ["vim-pencil"] = {
    loaded = true,
    path = "/home/sam/.local/share/nvim/site/pack/packer/start/vim-pencil",
    url = "https://github.com/preservim/vim-pencil"
  },
  ["vim-slime"] = {
    loaded = true,
    path = "/home/sam/.local/share/nvim/site/pack/packer/start/vim-slime",
  ...
  vimtex = {
    loaded = true,
    path = "/home/sam/.local/share/nvim/site/pack/packer/start/vimtex",
